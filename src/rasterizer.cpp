...
void Lurdr::drawPixel(const FrameBuffer & frame_buffer, long x, long y, RGBColor color)
{
...
void Lurdr::drawScanLine(const FrameBuffer & frame_buffer, long x1, long x2, long y, RGBColor color)
{
...
void Lurdr::standardTriangleRasterization(const FrameBuffer & frame_buffer, Vector2 v1, Vector2 v2, Vector2 v3, RGBColor color)
{
    long x1 = v1.x;
    long y1 = v1.y;
    long x2 = v2.x;
 ...
 */
void Lurdr::standardFillFlatTriangle(const FrameBuffer & frame_buffer, long y12, long y3, float x1, float x2, long x3, RGBColor color)
{
    assert(x1 >= 0 && x1 <= frame_buffer.getWidth());
    assert(x2 >= 0 && x2 <= frame_buffer.getWidth());
